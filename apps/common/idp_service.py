...
class IDPCommunicator:
    ...
    def get(self, url_path, auth_token=None, params=None, host=None):
        """Make get request."""
    ...
    def post(self, url_path, data=None, auth_token=None, params=None, host=None):
        """Make post request."""
...
def idp_post_request(url_path, data=None, auth_token=None, params=None, host=None):
    """Makes an IDP post request."""

    response = IDPCommunicator().post(url_path=url_path, data=data, auth_token=auth_token, host=host)
    if response.get("status_code") == 200:
        return True, response["data"]
    return False, response


def idp_get_request(url_path, auth_token=None, params=None, host=None):
    """Makes an IDP post request."""

    response = IDPCommunicator().get(url_path=url_path, auth_token=auth_token, params=params, host=host)
    if response.get("status_code") == 200:
        return True, response["data"]
    return False, response
